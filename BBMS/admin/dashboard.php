...
<head>
    ...
    <style>
        ...
        .dropdown-menu , .dropdown-menu a:hover {
            background-color: #660000; /* Change the color to match your navbar background */
        }
        #animated-image {
        height:25px;
        margin-top: 20px;
...
<body style="background-color: #ffffff;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color:#660000;">
    <a class="navbar-brand" href="../index.php" style="color: #ffffff;font-size:22px;letter-spacing:2px;">BBMS</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="?stock=1" style="color: #ffffff">Stock</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?donors=1" style="color: #ffffff">Donors</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?patients=1" style="color: #ffffff">Patients</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?donations=1" style="color: #ffffff">Donations</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?requests=1" style="color: #ffffff">Requests</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?donations_history=1" style="color: #ffffff">Donations History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?requests_history=1" style="color: #ffffff">Requests History</a>
                </li>
                <li>
                    <?php
                    echo 
